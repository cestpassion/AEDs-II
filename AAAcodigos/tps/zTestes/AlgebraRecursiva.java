    ...
    RecEquation(String str){
        ...
        if(str.charAt(0) == '3'){
            ...
            if(str.charAt(str.length() - 1) == ' '){
                this.eq = AlgebraRecursiva.substring(str, 8, str.length() - 1);
            }else{
                this.eq = AlgebraRecursiva.substring(str, 8, str.length());
            }
        }else{
            if(str.charAt(str.length() - 1) == ' '){
                this.eq = AlgebraRecursiva.substring(str, 6, str.length() - 1);
            }else{
                this.eq = AlgebraRecursiva.substring(str, 6, str.length());
            }            
        }
        ...
        if(this.eq.length() > 1){
            if(this.eq.length() > 1 && i >= this.eq.length() - 1){
                ...
                if(isSimple(i + 4)){
                    ...
                    this.eq = AlgebraRecursiva.substring(this.eq, 0, i) + resp + AlgebraRecursiva.substring(this.eq, j + 1, this.eq.length());
