/*
 * Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo de Inserção, fazendo com que a chave de pesquisa
 * seja o atributo capture-Date.
 * O nome do arquivo de log será a matrícula insercao.txt.
 */
...
/**
 * Ordenação por Inserção em Java
...
public class OrdenacaoPorInsercao {
    public static void main(String[] args){
        ...
        Ordenacao insercao = new Ordenacao(pokemonArray, index);
        ...
        int comparacoes = insercao.getComparacoes();
        int movimentacoes = insercao.getMovimentacoes(); 

        pokemonArray = insercao.getArray();
        for(int i = 0; i < index; i++)
            pokemonArray[i].imprimir();
        
        // Criar o arquivo de log
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("files/847503_insercao.txt"))) {
