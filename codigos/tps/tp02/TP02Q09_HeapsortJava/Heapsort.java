/*
 * Repita a questão de Ordenação por Seleção, contudo, usando o algoritmo Heapsort, fazendo com que a chave de
 * pesquisa seja o atributo height.
 * O nome do arquivo de log será matrícula heapsort.txt. (Lembre-se: em caso de empate, o critério de ordenação
 * deverá ser o nome do Pokémon
 */
...
public class Heapsort {
    public static void main(String[] args){
        ...
        Ordenacao heapsort = new Ordenacao(pokemonArray, index);
        ...
        int comparacoes = heapsort.getComparacoes();
        int movimentacoes = heapsort.getMovimentacoes(); 

        pokemonArray = heapsort.getArray();
        for(int i = 0; i < index; i++)
            pokemonArray[i].imprimir();
        
        // Criar o arquivo de log
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("files/847503_heapsort.txt"))) {
