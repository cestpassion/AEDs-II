 ...
 * valores binários (um para cada entrada) e a expressão booleana. Na sa´ıda padrão,
 * para cada linha de entrada, escreva uma linha de sa´ıda com SIM / NAO indicando se
